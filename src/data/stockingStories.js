  ...
  stories: [
    {
      ...
      lead: {
        intro:
          'Рыбу доставляют в специальных ёмкостях с аэрацией, затем постепенно привыкают к температуре пруда и выпускают в водоём — так сохраняется здоровье рыбы и баланс экосистемы. ',
        highlight:
          '14 апреля 2026 г. сюда поступил свежий карп массой от 700 г до 2 кг — всего более 300 кг,',
        outro: ' чтобы пруд оставался насыщенным и клёв — разнообразным.',
      },
    ...
    },
    {
      ...
      lead: {
        ...
        outro: ' Эта партия поддержала баланс популяции и разнообразие клёва для гостей усадьбы.',
      },
